...
export default function App() {
  ...
  const props = { kris, runs, excs, planner, settings, reference, notify, kriById, setView, setRunReq, focusExc, setFocusExc, saveKri, setKriStatus, updateExc, sendToPlanner, addPlannerItem, updatePlanner, draftPlan, saveCalendar, resetData };
